...
bvar_obj <- restrict_Gamma(bvar_obj, restriction_matrix)
...
plot(predict(m1, n.ahead=20, ci = 0.95))
```
...
#>  [7,]  0.00  0.00  0.00  1.22  3.94  0.73  0.93
