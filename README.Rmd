...
where $x_t$ is a vector of $d$ deterministic variables, $z_t' = \begin{pmatrix}y_{t-1}',\dots,y_{t-p}',x_t'\end{pmatrix}$
is a $k=mp + d$ dimensional vector and $\Gamma= \begin{pmatrix}A_1',\dots,A_p',C'\end{pmatrix}'$ is a $k \times m$ matrix.
